...
/** Optional actor metadata lets Voice V3 bind semantics and execution to the same player. */
export type ParsedCommand = ParsedCommandPayload & { actorPlayerId?: PlayerId }
